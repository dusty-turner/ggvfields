...
#' of length 2 (representing \eqn{(x, y)}). The underlying [Stat1d_2d] evaluates
...
#' @aliases geom_function_1d_2d stat_function_1d_2d Stat1d_2d
#' @export
NULL
...
#' @usage NULL
#' @export
Stat1d_2d <- ggproto("Stat1d_2d", Stat,
