...
, specified by either Cartesian (`dx`{.R}, `dy`{.R}) or polar (`angle`{.R}, `distance`{.R}) components. It’s especially useful for directional data like wind patterns or flow fields.
