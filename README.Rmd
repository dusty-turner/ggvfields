...
The directional derivative of a vector field $\mathbf{F} = (F_x, F_y)$ in the direction of a vector $\mathbf{v} = (v_x, v_y)$ is given by:
...
For a vector field, it is the rate of change of the field in the given direction.
