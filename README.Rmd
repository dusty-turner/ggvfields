...
**ggvfields** provides tools for visualizing vector fields, stream plots, and soon complex numbers and more. Let's start by creating some synthetic data that we can use to see its features.
...
By mapping the norm of a vector to the length aesthetic, users can directly observe differences in vector magnitude based on the vector's actual size.
...
This example demonstrates how `geom_vector_smooth()` can be used to fit a vector field to vector data. 
