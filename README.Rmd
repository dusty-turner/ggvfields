...
`geom_vector()` is designed to visualize individual vectors, specified by either Cartesian (`dx`, `dy`) or polar (`angle`, `distance`) components. It’s especially useful for directional data like wind patterns or flow fields.
